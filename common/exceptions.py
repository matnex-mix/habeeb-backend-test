...
class PermissionDeniedException(APIException):
    status_code = 403
    default_detail = "You don't have the permision to access this resource "
...
class NotAcceptableException(APIException):
    status_code = 406
    default_detail = 'Request cannot be processed, contact administrator'
    default_code = 'unacceptable'
